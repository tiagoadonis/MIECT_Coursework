...
public class HelloParser extends Parser {
	...
	public static final int
		RULE_head = 0, RULE_greetings = 1, RULE_bye = 2, RULE_name = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"head", "greetings", "bye", "name"
		};
	}
	...
	public static class HeadContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).enterHead(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).exitHead(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HelloVisitor ) return ((HelloVisitor<? extends T>)visitor).visitHead(this);
