...
public class Test {
	...
	public static void main(String[] args) throws Exception{
		...
		out.println("O veículo é conduzido por "+veiculo.getCondutor().getNome());
		out.println(veiculo.toString());
		out.println("");
		
		out.println("A mota sem atrelado é conduzida por "+motaSemAtrelado.getCondutor().getNome());
		out.println(motaSemAtrelado.toString());
		out.println("");
		
		out.println("A mota com atrelado é conduzida por "+motaComAtrelado.getCondutor().getNome());
		out.println(motaComAtrelado.toString());
		out.println("");
		
		out.println("O carro de cor "+ carroAzul.getCor() + " é conduzido por "+carroAzul.getCondutor().getNome());
		out.println(carroAzul.toString());
		out.println("");
		
		out.println("O carro com condutor ilegal de cor "+ carroComCondutorIlegal.getCor() + 
				    " é conduzido por "+carroComCondutorIlegal.getCondutor().getNome());
		out.println("O condutor tem a carta apropriada: "+(carroComCondutorIlegal.cartaValidaCondutor()?"Sim":"Não"));  
		out.println("");
		
		out.println("O camião de mercadoria é conduzido por "+camiaoMercadoria.getCondutor().getNome());
